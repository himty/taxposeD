...
from equivariant_pose_graph.models.pointnet import PointNet
...
class MultilaterationHead(nn.Module):
    ...
    def forward(
        self, *input, scores=None, return_flow_component=False, return_embedding=False, conditioning=None
    ):
